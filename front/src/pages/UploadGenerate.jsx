                  ...
                  <>
                    ...
                    <div className="space-y-2 mb-3">
                      {placeholderDocs.map((doc) => (
                        <div key={doc.id} className="p-4 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50/70">
                          <div className="flex items-center gap-3">
                            <FileText className="w-6 h-6 text-gray-300 shrink-0" />
                            <div className="min-w-0">
                              <p className="font-medium text-gray-400 truncate">{doc.title}</p>
                              <p className="text-xs text-gray-400">Placeholder para historial</p>
                            </div>
                          </div>
                        </div>
                      ))}
