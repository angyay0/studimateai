        ...
        <div className="max-w-7xl mx-auto p-8">
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: '🏆', title: 'Quiz Master', description: 'Completed 50 quizzes', date: 'Yesterday' },
                { icon: '🔥', title: '2 Week Streak', description: '14 days of consistent study', date: '2 days ago' },
                { icon: '⭐', title: 'Perfect Score', description: 'Scored 100% on a quiz', date: '1 week ago' }
